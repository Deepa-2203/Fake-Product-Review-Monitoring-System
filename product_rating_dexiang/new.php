...
<body>
	...
	$query = mysqli_query("INSERT INTO `products` (`productName` ,`price` ,`mrates`,`origin`,`mnation`)
	VALUES ('$name', '$year', '$ratings', '$origin','$nation')");
	#get product id
	$products = mysqli_query("SELECT * FROM `products` WHERE `productName`='$name'");
	...
	$mcate = mysqli_query("INSERT INTO `mcate`(`caID`, `productID`) VALUES ('$catID','$mID')");
	#inter relation to product and company
	$mcompany = mysqli_query("INSERT INTO `mcompany`(`companyID`, `productID`) VALUES ('$companyID','$mID')");
